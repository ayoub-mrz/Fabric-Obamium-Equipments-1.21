...
public class ModLootTableProvider extends FabricBlockLootTableProvider {
    ...
    public void generate() {
        ...
        addDrop(ModBlocks.OBAMIUM_ORE, oreDrops(ModBlocks.OBAMIUM_ORE, ModItems.RAW_OBAMIUM));
        addDrop(ModBlocks.OBAMIUM_DEEPSLATE_ORE,
                multipleOreDrops(ModBlocks.OBAMIUM_DEEPSLATE_ORE, ModItems.RAW_OBAMIUM, 1, 2));
        }
